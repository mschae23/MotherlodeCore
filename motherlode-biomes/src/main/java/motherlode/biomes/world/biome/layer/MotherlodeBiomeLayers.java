...
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddClimateLayers;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddDeepOceanLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddEdgeBiomesLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddInnerBiomesLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddIslandLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddRareIslandLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddRiversLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.AddShoresLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.ApplyOceanTemperatureLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.ContinentLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.IncreaseEdgeCurvatureBiomeLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.IncreaseEdgeCurvatureClimateLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.IncreaseEdgeCurvatureContinentLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.NoiseToRiverLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.OceanTemperatureLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.SetBaseBiomesLayer;
import de.martenschaefer.morecustomworldgen.customlayeredbiomesource.layer.vanilla.SimpleLandNoiseLayer;

public class MotherlodeBiomeLayers {
    // Continent layer
    ...
    public static <T extends LayerSampler<ClimateCategory>, T2 extends LayerSampler<ContinentCategory>, C extends LayerSampleContext<ClimateCategory, ClimateCategory, ClimateCategory, T, T, T>, C2 extends LayerSampleContext<ClimateCategory, ContinentCategory, ContinentCategory, T, T2, T2>> LayerFactory<ClimateCategory, T> buildClimateLayerFactory(LayerFactory<ContinentCategory, T2> continentLayer, LongFunction<C2> convertingContextProvider, ClimateConfig config, LongFunction<C> contextProvider) {
        ...
        climates = new AddSpecialBiomesLayer(config.getSpecialBiomeChance()).create(contextProvider.apply(3L), climates);
